...
class DcComicSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach($comics as $comic) {
            ...
            $DcNewComic = new DcComic();
            $DcNewComic->thumb = $comic['thumb'];
            $DcNewComic->title = $comic['title'];
            $DcNewComic->description = $comic['description'];            
            $DcNewComic->price = $comic['price'];
            $DcNewComic->series = $comic['series'];
            $DcNewComic->sale_date = $comic['sale_date'];
            $DcNewComic->type = $comic['type'];
            $DcNewComic->artists = implode(', ', $comic['artists']);
            $DcNewComic->writers = implode($comic['writers']);
            $DcNewComic->save();
